  ...
  return (
    ...
    <Slider {...settings}>
      ...
      <div className="card"  style={{margin: '0 15px'}}>
        ...
        <p>
          Explore the transformative impact of cutting-edge technologies on
          payment systems, reshaping the future of financial transactions.
        </p> 
     ...
     <div>
      <div className="card" style={{margin:  '0 15px'}}>
        ...
        <p>
          MLM relies on a distributor network. A strategic compensation plan
          is vital for financial success and sustained business growth.
        </p>
        <button className="view-articles-btn">View Articles</button>
      </div>
      </div>
